...
export class GifsService {
    ...
    private organizeHistory(tag: string) {
        ...
        tag = tag.toLowerCase(); //pasmaos a minusculas
    ...
    searchTag(tag: string): void {
        ...
        this.organizeHistory(tag); //llamaos al metodo de arriba para hacer validaciones del tag recibido
        ...
        //cuando hablamos de 'susbuscribirnos a los observables', significa estar escuchando las emisiones que ese
        ...
        this.http.get<SearchResponse>(`${this.serciceUrl}/search`, { params })
            .subscribe( resp => {
                ...
                this.gifList = resp.data; //agregamos los gifs obtenidos en la varaible creada arriba en propiedades
